...
public class OA {
    ...
    public static void commonBoss(Node root,Map<String,List<String>> roles){
        System.out.println("Enter user 1");
        String user1=sc.next();
        System.out.println("Enter user 2");
        String user2=sc.next();
        // String res=topBoss(user1, user2)
        List<String> list=roles.get(root.val);
        System.out.println("Top most common boss :"+list.get(0));
    }

    // public static string topBoss(Node l1,Node l2){
    //     String res="";
