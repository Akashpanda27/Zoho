...
public class RoleHierarchy {
    ...
    public static void main(String[] args) {
        ...
        String operations[]=new String[]{"Add Sub Role.","Display Roles","Delete Role.","Add User.","Display Users.","Display Users and Sub Users.","Delete User.","Number of users from top.","Height of role hierachy.","Common boss of users"};
